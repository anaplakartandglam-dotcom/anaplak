...
export class Typed {
    ...
    constructor(options, customSetup) {
        ...
        this._typeQueue = new QueueManager('type', this._resetter, (_a = this._options.namedParts) !== null && _a !== void 0 ? _a : [DEFAULT_PART_NAME]);
        this._ffQueue = new QueueManager('ff', this._resetter, (_b = this._options.namedParts) !== null && _b !== void 0 ? _b : [DEFAULT_PART_NAME]);
    ...
    type(sentance, options) {
        var _a;
        const partName = (_a = options === null || options === void 0 ? void 0 : options.namedPart) !== null && _a !== void 0 ? _a : DEFAULT_PART_NAME;
        this._typeQueue.add({
            type: 'sentance',
            partName,
            text: sentance,
    ...
    wait(delay, options) {
        ...
        this._typeQueue.add({
            type: 'wait',
            partName: (_a = options === null || options === void 0 ? void 0 : options.namedPart) !== null && _a !== void 0 ? _a : DEFAULT_PART_NAME,
            delay,
        });
        return this;
    }
    ...
    updateText() {
        ...
        if (!((_a = this._options.namedParts) === null || _a === void 0 ? void 0 : _a.length)) {
            this._options.callback((_b = text[DEFAULT_PART_NAME]) !== null && _b !== void 0 ? _b : '');
        }
        else {
