...
export const metadata: Metadata = {
  title: "Beauty Tips, Hair Care & Bridal Makeup Blogs in Chennai, Maduravoyal | Anaplak Art & Glam",
  ...
  openGraph: {
    title:
      "Beauty Tips, Hair Care & Bridal Makeup Blogs in Chennai, Maduravoyal | Anaplak Art & Glam",
